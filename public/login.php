    ...
    if (isset($_POST['register'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($update_stmt->execute()) {
                echo "<script>alert('Erregistro arrakastatsua. Saioa has dezakezu orain!'); window.location.href = 'login.php';</script>";
            } else {
                echo "<script>alert('Errorea erabiltzailea erregistratzean. Mesedez, saiatu berriro.'); window.location.href = 'login.php';</script>";
            }
        } else {
            echo "<script>alert('Langilearen ID ez da aurkitu. Mesedez, egiaztatu eta saiatu berriro.'); window.location.href = 'login.php';</script>";
        }
        ...
        if (empty($erabiltzailea) || empty($pasahitza)) {
            echo "<script>alert('Erabiltzaile izena eta pasahitza bete behar dituzu.'); window.location.href = 'login.php';</script>";
            exit();
        }
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if (password_verify($pasahitza, $row['pasahitza'])) {
                ...
                echo "<script>alert('Erabiltzailea edo pasahitza okerra.'); window.location.href = 'login.php';</script>";
                exit();
            }
        } else {
            echo "<script>alert('Erabiltzailea edo pasahitza okerra.'); window.location.href = 'login.php';</script>";
    ...
    <main>
        <div class="kontainerra__dena">
            ...
            <div class="contenedor__login-register">
                <!--Logina-->
                <form action="login.php" method="post" class="formulario__login" onsubmit="return validarFormulario()">
                    <h2>Saioa hasi</h2>
                ...
                <!--Erregistroa-->
                <form action="login.php" method="post" class="formulario__register" onsubmit="return validarFormulario()">
                    <h2>Erregistratu</h2>
