    ...
    <section class="sekzioa1" id="sekzioa1">
      <div class="container marcial-box">
        <div class="marcial-irudia-content">
          ...
          <p class="deskripzioa">Bidezko indarra, bidezko bidea. Klase pertsonalak eta arte martzial ezberdinak, gym
            propio batekin</p>
          <div class="marcial-box-botoiak"><button>Kategoriak...</button><button><a
                href="#Lehiaketak">Kurtsoak</a></button></div>
        </div>
      </div>
    </section>
      ...
      <div class="container guburuz">
        ...
        <div class="section-guburuz-irudiak">
          <figure class="guburuz-box_irudiak">
            <img src="img/Kendo.jpg" alt="navigation icon" class="nav-hamburger" width="320" height="190" style="--i: 0"
              data-aos="fade-down-right" />
            <img src="img/marcial.jpg" alt="navigation icon" class="nav-hamburger" width="320" height="190"
              style="--i: 0" data-aos="fade-down-right" />
            <img src="img/aikido.jpg" alt="navigation icon" class="nav-hamburger" width="320" height="190"
              style="--i: 0" data-aos="fade-down-right" />
          </figure>
        </div>
      </div>
    ...
    <section class="section-kontaktua" id="kontaktua">
      <div class="container kontaktua">
        <div class="kontaktuak">
          <form>
            <h2 class="tituloa">Kontaktatu hemen!!</h2>
        ...
        <div class="mapa">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11284.244287121758!2d-1.4404!3d43.1316!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd51a9d8133ba2f1%3A0x34df88f0b1c682f1!2sTolosa%2C%20Gipuzkoa!5e0!3m2!1sen!2ses!4v1699191706300!5m2!1sen!2ses"
            allowfullscreen="" loading="lazy" style="border: 0" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </section>
    </div>
      ...
      <div class="contact-details">
        ...
        <div class="contact-social-links">
          <img src="https://vfitclub.netlify.app/image/whatsapp.svg" alt="navigation icon" class="nav-hamburger"
            ...
            src="https://vfitclub.netlify.app/image/instagram.svg" alt="navigation icon" class="nav-hamburger" width=35"
            height="35" /> <img src="https://vfitclub.netlify.app/image/twitter.svg" alt="navigation icon"
            class="nav-hamburger" width=35" height="35" />
        </div>
      </div>
